...
/***/ function(module, exports, __webpack_require__) {
	...
	var Save = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Save\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var Main = React.createClass({
		...
		getArticleHistory: function getArticleHistory() {
			axios.get('/api/save').then(function (response) {
				this.setState({
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'p',
							null,
							'Search for an annotate articles of interest!'
						)
					),
					React.createElement(
						'div',
						...
						React.createElement(
							...
							React.createElement(Search, { searchTerm: this.state.searchTerm, saveArticle: this.saveArticle })
						),
						React.createElement(
							'div',
							{ className: 'panel-heading' },
							...
							React.createElement(Save, { articleHistory: this.state.articleHistory })
						)
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
		...
		runQuery: function runQuery(articleSearch) {
		...
		postHistory: function postHistory(articleSearch) {

			return axios.post('/api', { articleSearch: articleSearch }).then(function (results) {
